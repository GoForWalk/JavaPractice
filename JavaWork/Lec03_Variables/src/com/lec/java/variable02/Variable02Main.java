...
public class Variable02Main {
	...
	public static void main(String[] args) {
		...
		byte num2 = 0;
		byte num3 = 123;
//		byte num4 = 1234;	// byte: -128 ~ 127 //에러: byte 에 저장 할 수 있는 크기를 넘어섬
		...
		short num6 = 12345;
		short num7 = 32767;
//		short num8 = 32768;		//short: -32000 ~ 32000
//		short num9 = -32769;	//short: -32000 ~ 32000
...
//		long num10 = 9876543210;	//에러: The literal 9876543210 of type int is out of range 
									//리터럴 : literal
									//코드상에 직접 입력한 값들
		// 정수 리터럴 --> int 로 형변환 하려 한다. (대표: int)
		// 실수 리터럴 --> double로 형변환 하려 한다. (대표: double)
		// "~" 리터럴 --> 문자열(String)로 형변환
		//...
		
		long num11 = 9876543210L; //<--long 형 리터럴로 인식한다.
		long num12 = 12;	//4byte
		long num13 = 12L; 	//8byte
		int num14 = 12;
//		int num15 = 15L; //에러: long 타입은 int 에 대입 불가
...
//		값의 경계선
		...
		System.out.println("number1 = " + String.format("%x", number1)); //number1 을 16진수로 출력하라.
		System.out.println("number1 = " + String.format("%o", number1)); //number1 을 8진수로 출력하라.
		
		// Integer.ToXxx(n)을 사용하여 원하는 포맷의 문자열로 변환 가능
		System.out.println("number1 = " + Integer.toHexString(number1));	//number1 를 16진수 문자열 변환
