...
public class Variable04Main {
	public static void main(String[] args) {
		...
		System.out.println("ch7 + 1 = " + (ch7 + 1)); //정수값 출력
		System.out.println("ch7 + 1 = " + (char)(ch7 + 1)); //char 형변환 
		...
		System.out.println(10 < 20); //boolean type 으로 나온다
		System.out.println(10 > 20); //boolean type 으로 나온다
