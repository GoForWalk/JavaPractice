...
public class Array01Main {
	...
	public static void main(String[] args) {
		...
		//...
		// 다량의 데이터를 위해서 매번 변수를 작성하는 건... 사실상 불가.
		
		// 배열의 선언, 초기화
		int[] korean = new int[3]; 
		// int 형 배열 선언 
		// 3개의 new int data를 담는 배열로 초기화
		
		korean[0] = 90; // 첫번째 배열원소에 90 대입 (배열 index는 0 부터 시작)
		korean[1] = 80;
		korean[2] = 70;
...
//		korean[3] = 60; //err: Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: 3
//								at com.lec.java.array01.Array01Main.main(Array01Main.java:52)
		...
		int[] english;
		english = new int[5]; //초기화
		
		System.out.println(english[1]); //에러 아님.... 0 나옴, 초기화 한적 없는데 0 나옴!! - 자동초기화 된 값
