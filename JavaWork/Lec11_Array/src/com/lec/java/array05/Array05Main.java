...
//		System.out.println(array[3][0]); // err :  java.lang.ArrayIndexOutOfBoundsException
		...
		System.out.println("array[0].lengh = " + array[0].length);
		System.out.println("array[1].lengh = " + array[1].length);
