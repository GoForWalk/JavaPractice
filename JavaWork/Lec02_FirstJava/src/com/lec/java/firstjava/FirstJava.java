...
//		System.out.println(안녕하세요); // 에러
		...
		System.out.println(3.141592 * 10 * 10); //숫자로 인식
		System.out.println(10 * 10 / 2);
		
		// + 연산자의 여러가지 동작
		System.out.println("안녕하세요" + " 여러분"); 	//좌우측 중 한개라도 "문자열" 이면 '문자열 연결' 연산 수행
		System.out.println("결과: " + 10); 			// 10 을 문자열로 변경한 뒤, 문자열 끼리 연결하는 연산
		System.out.println("결과: " + 10 + 20);		//10을 문자열 바꾸고 , 20 문자열 바꾸고, 문자열 연결
		System.out.println("결과: " + (10 + 20));		// 10+20을 연산한 뒤, 30을 문자열로 바꾸거 문자열 연결
