...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1길이: " + str2.length());
...
//		System.out.println(str3.length()); //err: NullPointerException  - null 에는 . 을 찍을 수 없다.
...
//		System.out.println(str1.charAt(20)); // err: StringIndexOutOfBoundsException - 인덱스 범위 벗어남
		...
		System.out.println();
		System.out.println("split(regex)"); // 문자열을 주어진 문자열로 쪼개어 String[] 리턴 // 배열 리턴 중요!!
		...
		System.out.println(str8.substring(2,5)); //2 부터 5 전 까지
