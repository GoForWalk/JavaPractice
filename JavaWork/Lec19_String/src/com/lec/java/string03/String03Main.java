...
public class String03Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1); // String - immutable : str1 이 실제 변경되지 않는다. 
		System.out.println();		// MA 안의 String 객체 값은 변하지 않는다. 
		...
		// StringBuffer 가 속도가 더 빠르기 때문에~ 실무에서는 String 보다 StringBuffer를 더 많이 사용한다.
		// 더 빠른 이유, StringBuffer는 값이 바로 바뀌기 때문에~
