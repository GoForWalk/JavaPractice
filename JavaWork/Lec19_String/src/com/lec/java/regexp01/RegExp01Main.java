...
public class RegExp01Main {
	...
	public static void main(String[] args) {
		...
		regex = "My...."; // My로 시작하고 임의의 문자 4개 패턴
		...
		System.out.println(matcher.replaceFirst("XXXX")); // My1234 를 XXXX로 교체
		...
		if(Pattern.matches("My....", "Myabcd")) { //대소문자, 길이 구분
