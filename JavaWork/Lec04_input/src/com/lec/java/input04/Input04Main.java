...
//		int i1 = sc.next(); // next()의 결과는 문자열 따라서 int 변수에 담을 수 없다.
		String in1 = sc.next();
		...
		System.out.println("실수 3개(double, double, double)를 입력받으세요>");
		double d1 = Double.parseDouble(sc.next()); // 입력받은 문자열을 double 로 전환
