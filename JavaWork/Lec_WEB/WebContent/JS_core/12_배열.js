...
// 1. isArray() : ES5.1 부터 지원. (구형 인터넷 익스프롤러에서는 지원하지 않는다.)
console.log(Array.isArray(fruits)); // 주어진 변수값이 배열일 경우 true 리턴
...
console.log(fruits.slice(1,3)); // 1부터 시작해서 3 전까지 ( 3 포함 X )
