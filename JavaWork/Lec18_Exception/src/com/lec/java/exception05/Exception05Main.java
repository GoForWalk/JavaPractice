...
//		-------------------------------------------------------------
		...
		try {
			System.out.println("#2 try{} 시작");
			int[] numbers = new int[10];
			numbers[10] = 123; // 오류 발생: ArrayIndexOutOfBoundsException
			System.out.println("#3 try{} 종료");
		} catch (ArrayIndexOutOfBoundsException ex) {
			System.out.println("#4 catch{} 시작");
			System.out.println("예외 메세지: " + ex.getMessage());
...
//			System.out.println("예외 메세지: " + ex.getMessage());
//			
//			return; // return 삽입 시에도 finally 는 구동
//			
//		} finally {
//			System.out.println("#5 finally{}");
//		}
//		System.out.println("#6 try {} 종료후 "); // return 으로 안나타남
//		
//		----------------------------------------------------------
		...
		try {
			System.out.println("#2 try{} 시작");
			String str = null;
			str.length(); // 오류 발생: NullPointerException
			System.out.println("#3 try{} 종료");
		} catch (ArrayIndexOutOfBoundsException ex) {
			System.out.println("#4 catch{} 시작");
			System.out.println("예외 메세지: " + ex.getMessage());
