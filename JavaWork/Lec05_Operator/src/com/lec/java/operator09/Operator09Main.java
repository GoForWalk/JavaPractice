...
public class Operator09Main {
	...
	public static void main(String[] args) {
		...
		byte b1 = 10 ,b2 = 20;
//		byte b3 = b1 + b2; // 에러: byte + byte -> int
//		byte b3 = b1 + 10; // 에러
		
		short s1 = 10, s2 = 20;
//		short s3 = s1 + s2; // 에러: short + short -> int
//		short s3 = b1 + s1; // 에러: short + byte -> int
		
		char ch1 = 10, ch2 = 20;
//		char ch3 = ch1 + ch2; // 에러: char + char -> int
		char ch3 = (char)(ch1 + ch2); // 명시적 형변환 시 에러 X
...
//		f3 = f1 + d1; // 에러 : float + double -> double
		...
		l2 = 3000 * 3000 * 3000; // int * int * int = int
		System.out.println("L2 = " + l2);
		
		l2 = 3000 * 3000 * (long)3000;
		System.out.println("L2 = " + l2);

		l2 = (long)(3000 * 3000 * 3000);
		System.out.println("L2 = " + l2);
		
		//자바의 연산결과 타입규칙과
		//기본 데이터 타입의 한계값 인지하고 있어야함.
