...
public class RockScissorPaper {
	...
	public static final String[] choiceOption = {"가위", "바위", "보"};
	...
	public static void displayChoice(int user, int com) {
		...
		System.out.println("유저의 선택: " + getHandType(user) + "(" + user + ")" );
		System.out.println("컴퓨터의 선택: " + getHandType(com) + "(" + com + ")" );
	...
	public static void computeResult(int user, int com) {
		...
		int userChoiceCompile = 0;
		userChoiceCompile = (user + 1) > 3 ? 1 : (user + 1);
		
		if(user == com) {
			System.out.println("비겼습니다!");
		} else if(userChoiceCompile == com) {
