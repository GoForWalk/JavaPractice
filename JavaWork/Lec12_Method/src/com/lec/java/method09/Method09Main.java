...
public class Method09Main {
	...
	public static void main(String[] args) {
		...
		int n = 10;
		incNum(n);
		System.out.println("incNum(int) 호출 후 n : " + n); 	// primitive type 의 사본  - 원본이 바뀌지 않는다. 
															//						- Stack 에서 사본을 만들고 삭제
		System.out.println();
		
		int[] arr = {10};
		incNum(arr);
		System.out.println("incNum(int[]) 호출 후 arr[0] : " + arr[0]); 	// reference type 의 사본 	- Heap의 원본을 건드린다.
																		//						- Stack에서는 주소값 사본을 생성
