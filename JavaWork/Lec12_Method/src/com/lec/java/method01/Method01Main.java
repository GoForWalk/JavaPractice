...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		sayHello2("김우경", 25);
//		sayHello2(100, 200); 	//err: not applicable for the arguments (int, int)
								// 정의 되어 있는 매개변수 리스트와 다르게 호출하려 했을 때
	...
	// 메소드 위에 아래와 같이 javadoc 타입 주석을 달수 있다.
	/**
	 * 메소드이름: sayHello
	 * 주어진 이름을 출력합니다.
	 * @param name 이름
	 */
	public static void sayHello(String name) { //메소드 정의, signiture : sayHello(String)
		System.out.println("안녕하세요.");
		System.out.println("제 이름은  " + name + " 입니다."); 
		// 메인 메소드의 호출이 끝나고 값이 돌아가는 과정 = return 
	}
	...
	//	2) int age
	// 리턴 타입: void
	public static void sayHello2(String name, int age) { //signiture : sayHello2(String, int)
