...
public class Method02Main {
	...
	//   2) int y
	// 리턴타입: int
	public static int add(int x, int y) {// 리턴이 없을 경우 : err: must insert return
		int result = x + y;
	...
	public static String divide2(int x, int y) {
		String result = y == 0 ? "0으로 나눌 수 없습니다" : "몫은" + divide(x, y) + "이고 , 나머지는 " +  (x % y) + " 입니다.";
