...
//		403  권한에러 Forbidden : 파일권한, 읽기권한, SSL, IP, 등...  <--- 웹 크롤링 하다가 은근히 자주 마주치게 되는 에러
		...
		System.out.println(doc.title()); // <title> element 의 텍스트  // 브라우저의 tab에 보이는 NAVER 
...
//		System.out.println(element.outerHtml());
		...
		for(Element e : newsElements) {
			...
			System.out.println(element.text()); // Element 의 text() -> text 들을 하나로 묶어 하나로 리턴
