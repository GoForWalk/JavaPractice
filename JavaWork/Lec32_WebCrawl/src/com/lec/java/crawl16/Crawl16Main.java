...
//		맛집 이름 / 평점
		...
		for(RestaurantsObject e : yogiyo.getRestaurants()) {
			System.out.printf("%s\t 평점: %.1f\n", e.getSlug(), e.getReviewAvg());
		}
...
public static StringBuffer readFromUrl(String urlAddress) {
		...
		try {
			...
			if(conn != null) {
				...
				conn.addRequestProperty("x-apisecret", "fe5183cc3dea12bd0ce299cf110a75a2");
...
class RestaurantsObject {
	...
	public RestaurantsObject(String slug, double reviewAvg) {
		super();
		this.slug = slug;
...
class Yogiyo {
	...
	private ArrayList<RestaurantsObject> restaurants;
	public Yogiyo() {
		super();
	}
	public Yogiyo(ArrayList<RestaurantsObject> restaurants) {
		super();
		this.restaurants = restaurants;
	}
	public ArrayList<RestaurantsObject> getRestaurants() {
		return restaurants;
	}
	public void setRestaurants(ArrayList<RestaurantsObject> restaurants) {
		this.restaurants = restaurants;
	}
