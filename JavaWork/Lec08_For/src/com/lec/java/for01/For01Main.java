...
public class For01Main {
	...
	public static void main(String[] args) {
		...
		// 지역변수(local variable) : 블럭{...} 안에서 선언한 변수는 선언한 블럭 안에서만 사용 가능.
		// 블력이 끝나면 소멸됨.
...
//		System.out.println("for 종료후 k = " + k);
		
		{
			...
			System.out.println("a = " + a);
			{
				...
				// 바깥블럭 자역변수와 동일 이름의 변수 사용 불가
//				int a = 200; // err: Duplicate local variable a
				int b = 200;
				System.out.println("b: " + b);
			}
//			System.out.println("b: " + b); //err:  cannot be resolved to a variable
		}
//		System.out.println(a); // err:  cannot be resolved to a variable
