...
/* 트랜잭션 (Transaction)
 * 	데이터베이스의 '작업'의 단위,  
 *  '하나의 트랜잭션'은  '일련의 쿼리연산(들)' 로 구성  -- 쪼갤 수 없는 과정!!
 *  
...
public class DB05Main implements Query {
	...
	public static void main(String[] args) {
		...
		try {
			...
			stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '5번째', SYSDATE)");
			stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '6번째', SYSDATE)");
