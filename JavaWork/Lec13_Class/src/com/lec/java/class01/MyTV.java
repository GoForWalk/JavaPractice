...
public class MyTV {
	...
	// TV 의 상태(속성) --> (멤버)변수
	// 멤버변수 : 같은 클래스 에서 정의된 모든 메소드에서 사용가능.
	
	private boolean isPowerOn;	// 전원이 on/off - class 블럭의 변수
	private int channal;		// 현재 채널
	...
	public void displayStatus() {
		...
		System.out.println("---------------------------------");
		System.out.println("전원 상태: " + isPowerOn); // 동일클래스 안의 멤버들 서로 사용가능
		System.out.println("채널 상태: " + channal);
