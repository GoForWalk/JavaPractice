...
public class Wrapper01Main {
	...
	public static void main(String[] args) {
		...
		if(num1 == num2) {
			...
			System.out.println("num1 == num2 : 다르다"); // 다르다!
		}
		
		if(num1.equals(num2)) {
			System.out.println("num1.equals(num2) : 같다");
		} else {
			System.out.println("num1.equals(num2) : 다르다"); // 다르다!
		}
		...
		Integer num4 = Integer.valueOf(123);
					// valueOf()는 생성한 Object를 cathe 해둔다.
					// 동일 literal 로 valueOf() 생성하면, 기존의 생선된 Object 리턴.
					// 왜? .. 메모리 절약
		...
		System.out.println();
		Integer num5 = 123;
		// Integer.valueOf(123) 과 동일한 코드가 작동됨 (Auto-Boxing)
		if(num4 == num5) {
		...
		// 5. valueOf(문자열) 가능!
		Integer num6 = Integer.valueOf("123"); // int 123으로 변경
		System.out.println(num6);
		
		if(num6 == num5) {
			System.out.println("같은 참조"); //같은 참조 : Wrapper 의 연산 결과는 새로운 Wrapper 생성 (immutable)
		...
		if(num6 == num5) {
			...
			System.out.println("다른 참조"); //다른 참조 Wrapper는 immutable 하다!
		} 
