...
//		TestInterface t1 = new TestInterface(); //추상메소드를 가지고 있는 존재는 new 불가능
...
//		System.out.println(test2.MIN); 	// 두 interface 에서 모두 MIN이 있어서 에러
										// .MIN is ambiguous (모호성)
...
//	private String KOTLIN_STRING = "Kotlin"; // public static final 만 가능하다.
