...
//		TestAbstract test1 = new TestAbstract(); // err: Cannot instantiate the type TestAbstract
		...
		// 다형성
		TestAbstract test3 = new TestClass(); // <-- 자동 형변환 가능
		test3.testMethod();
...
abstract class TestAbstract{ // 추상 클래스 (abstract 꼭 붙이기!!)
...
// 추상클래스를 상속받는 클래스는 반드시 추상메소드를 구련(implement) 해야함
...
class TestClass extends TestAbstract{
	...
	@Override
	public int testMethod() { // implement
